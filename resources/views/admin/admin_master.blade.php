...
<!--   
  ...
  //  switch(type){
  //    case 'info':
  //     toaster.info ("{{Session::get('message')}}");break;
  //     case 'success':
  //     toaster.success("{{Session::get('message')}}");break;
  //     case 'warning':
  //     toaster.warning("{{Session::get('message')}}");break;
  //     case 'error':
  //     toaster.error("{{Session::get('message')}}");break;}
  //   @endif } -->
